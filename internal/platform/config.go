...
type Config struct {
	SendGridKey, ReviewEmailFrom, ReviewEmailTo                                                                                                                                                                                                                                              string
	OpenAITutorModel                                                                                                                                                                                                                                                                         string
	OperatorPreparationDailyLimit                                                                                                                                                                                                                                                            int
	HiddenSuiteMasterKey, HiddenSuiteKMSKeyID, HiddenSuiteKMSRegion                                                                                                                                                                                                                          string
