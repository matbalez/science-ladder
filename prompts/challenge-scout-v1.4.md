# Science Ladder Challenge Scout · 1.4.0
...
6. **Explain.** Write `education.frontier` and
   ...
   reader, not marketing copy. Frontier: explain the problem, what the strongest
...
7. **Draft.** If viable, write the files below and execute meaningful tests when tools
